...
def driver(request):
    # Фикстура для инициализации веб-драйвера с поддержкой Chrome и Firefox, чтобы избедать проблем с драйверами.
...
def create_new_user_and_delete():
    # Фикстура для создания временного пользователя с автоматическим удалением. Генерация случайных учетных данных
    payload_cred = {
